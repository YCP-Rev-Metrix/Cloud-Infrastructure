    ...
    private static void Main(string[] args)
    {
        ...
        _ = builder.Services.AddCors(options =>
        {
            options.AddPolicy("AllowAll",
                builder => builder.WithOrigins("https://api.revmetrix.io", "https://docs.revmetrix.io", "https://research.revmetrix.io", "https://github.com", "https://localhost:7238", "https://localhost:8081", "http://localhost:8081")
